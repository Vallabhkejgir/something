...
# Add import
if "from app.services.cache import query_cache" not in content:
    content = content.replace("from app.RAG.graph import rag_app, GraphState", "from app.RAG.graph import rag_app, GraphState\nfrom app.services.cache import query_cache")
...
async def query(req: QueryRequest):
    ...
    try:
        ...
        await query_cache.set(user_prompt, {"answer": final_state["answer"]}, store_manager.index_version)
